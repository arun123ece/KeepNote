...
public class Note {
	...
	public Note(Integer noteId, String noteTitle, String noteContent, String noteStatus, Date noteCreationDate,
			Category category, List<Reminder> reminder, String noteCreatedBy) {
		super();
		this.noteId = noteId;
	...
	public String toString() {
		return "Note [noteId=" + noteId + ", noteTitle=" + noteTitle + ", noteContent=" + noteContent + ", noteStatus="
				+ noteStatus + ", noteCreationDate=" + noteCreationDate + ", category=" + category + ", reminder="
